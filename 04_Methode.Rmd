...
Es ist zu beachten, dass fast alle Parameter keine exakt abgrenzbaren Klassengrenzen aufweisen. 
Die Erhebung kommt bei den Parametern "Störung", "Beuteangebot", "Katzen" und "andere Feinde" einer Schätzung gleich; die Beurteilung erfolgte aufgrund von Indizien wie der Nähe zu Wanderrouten bzw. der Sichtung von Maushaufen bzw. Siedlungsnähe bzw. der Lebensraumqualität für grössere Prädatoren. 
Dagegen ist das Alter eindeutig bestimmbar und Volumen sowie Astmaterial kann direkt dokumentiert und somit relativ zu den anderen Asthaufen beurteilt werden. (grobes Astmaterial; Klasse 1 vgl. Foto \@ref(fig:astmaterial) links und feines Astmaterial; Klasse 4 vgl. \@ref(fig:astmaterial) rechts). 
DIE FOTOS SIND ZIEMLICH UNDEUTLICH/UNSCHARF, SONST WÄRE DIR DIE KLASSENZUTEILUNG KLAR GEWESEN... 
