...
Bei **Erhebung 1** handelt es sich um eine systematische Kontrolle ausgewählter Asthaufen während zweier Jahre (2019 / 2020) über einen definierten Zeitraum. Diese Erhebungen wurden nach einheitlicher Vorgehensweise durchgeführt. Im gleichen Zeitraum wurden in **Erhebung 2** sogenannte Winterquartiere (siehe [wieselundco.ch/bonus](http://www.wieselundco.ch/bonus)), ebenfalls systematisch beobachtet.
...
- leere Spurenpapiere wurden nicht systematisch dokumentiert. Es ist nicht genau nachvollziehbar, wie intensiv eine Struktur beobachtet wurde. Der Nachweis_erfolg_ kann somit kaum in den Kontext des Nachweis_efforts_ gesetzt werden.
