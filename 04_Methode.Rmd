...
Die Erhebung erfolgte am 30. und 31. März 2021. Von den 50 kontrollierten Asthaufen wurden jene 12 ohne Nachweise ("unattraktivsten") und jene 13 mit 2 bis 7 Nachweisen ("attraktivsten") qualitativ beurteilt. Dabei wurden 10 Parameter erhoben und jeweils einer der Klassen 0 bis 4 
zugeteilt. Dabei stellen tiefe (Klassen-) Werte eher *positive* Attributsausprägungen dar und hohe Werte eher *negative*. 
...
Die Parameter und ihre Skalenrichtung ist im [Anhang](#anhang-asthaufen-qualitaet) ersichtlich. Dabei ist zu beachten, dass fast alle Parameter keine exakt abgrenzbaren Klassengrenzen aufweisen. Die Erhebung kommt bei den Parametern "Störung", "Beuteangebot", "Katzen" und "andere Feinde" einer Schätzung gleich; die Beurteilung erfolgte aufgrund von Indizien wie der Nähe zu Wanderrouten bzw. der Sichtung von Maushaufen bzw. Siedlungsnähe bzw. der Lebensraumqualität für grössere Prädatoren. Dagegen ist das Alter eindeutig bestimmbar und Volumen sowie Astmaterial kann direkt dokumentiert und somit relativ zu den anderen Asthaufen beurteilt werden. (grobes Astmaterial; Klasse 4 vgl. \@ref(fig:grob) links und feines Astmaterial; Klasse 1 vgl. Foto \@ref(fig:fein) rechts). 

Zur Auswertung wurden die Klassen 0 bis 2 (am Bsp. Astmaterial: "feines Material") und 3 bis 4 (am Bsp. Astmaterial: "grobes Material") zusammengefasst. In der Folge wurde je Klasse die Anzahl der  Asthaufen mit Nachweisen jener Anzahl ohne Nachweise in einem statistischen Verfahren 
<!-- NAME? -->
gegenüber gestellt.

```{r fein}
knitr::include_graphics("images/feines_astmaterial.jpg")
```

```{r grob}
knitr::include_graphics("images/grobes_astmaterial.jpg")
```
